    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="header_add">
                <form method="post" action="{{ route('tarij_report_export') }}" id="tarij_export" enctype="multipart/form-data">
                    @csrf
                    <div class="form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <form method="post" action="{{ route('tarij_report_export') }}" id="tarij_export">
                                        @csrf
...
@push('script')
    <script>
        ...
        $('#submitBtn').on('click', function() {
            ...
            var formData = $('#tarij_export').serialize();

            // Submit form data using AJAX
            $.ajax({
                url: $('#tarij_export').attr('action'),
                type: 'POST',
                data: formData,
