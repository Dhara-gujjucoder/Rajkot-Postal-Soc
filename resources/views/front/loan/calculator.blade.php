                            ...
                            <div class="col-form-info">
                                <form action="/">
                                    <div id="comission" class="range-slider">
                                        ...
                                        <input class="custom-range" id="loan_range" type="range" min="50000" max="200000" step="50000">
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="dashboard-detail-data">
                            ...
                            <div class="col-form-info pt-0">
                                ...
                                <div class="min-amount" id="amt_min" style="color: red; display:none;">
                                    <label>*Minimum Amount:</label><input class="w3-input w3-border-0" type="text"
                                        id="min_amt" style="border: none;color: red;">
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('script')
    ...
    <script>
        document.getElementById("loan_range").addEventListener('input', function() {
            let min_val = parseInt(this.value, 10);
            let min_value;
