        ...
        <div class="container">
            ...
            <form action="{{ route('user.password.change') }}" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <div class="eye-settle">
                            <input id="password_confirm" type="password" placeholder="{{ __('Confirm Password') }}" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" autocomplete="new-password">
