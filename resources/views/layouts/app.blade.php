...
<head>
    ...
    <title>{{ (isset($page_title) ? $page_title : '') . ' | ' . Config::get('name', $setting->title ?? 'Rajkot Postal Soc.') }}</title>

    <link rel="shortcut icon" href="{{ asset(isset($setting) ? $setting->favicon : 'assets/images/favicon.png') }}" type="image/x-icon">
