    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @endcanany
                @canany(['create-ledger_entries', 'edit-ledger_entries', 'delete-ledger_entries', 'view-ledger_entries'])
                ...
                @canany(['edit-general-setting', 'loaninterest-setting', 'share-amount-setting', 'monthly-saving-setting'])
                    <li class="sidebar-item has-sub {{ request()->is('admin/general/setting/*') || request()->is('admin/loaninterest*') || request()->is('admin/shareamount*') || request()->is('admin/monthlysaving*') ? 'active' : '' }}">
                        <a href="#" class="sidebar-link">
