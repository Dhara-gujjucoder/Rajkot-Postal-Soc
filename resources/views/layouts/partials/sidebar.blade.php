    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @canany(['create-loan_matrix', 'edit-loan_matrix', 'delete-loan_matrix', 'view-loan_matrix', 'create-loaninterest', 'edit-loaninterest','delete-loaninterest', 'view-loaninterest'])
                    <li
                ...
                @canany(['edit-general-setting', 'loaninterest-setting', 'share-amount-setting',
                    'monthly-saving-setting'])
                    <li
                        class="sidebar-item has-sub {{ request()->is('admin/general/setting/*') || request()->is('admin/shareamount*') || request()->is('admin/monthlysaving*') ? 'active' : '' }}">
                        <a href="#" class="sidebar-link">
                        ...
                        <ul class="submenu {{ request()->is('admin/general/setting/*') ? 'active submenu-open' : '' }}">
                            ...
                            @endcan
                            @canany(['create-financial_year', 'edit-financial_year', 'delete-financial_year',
                                'view-financial_year'])
