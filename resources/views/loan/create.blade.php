                ...
                <div class="card-body">
                    <form action="{{ route('loan.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                                ...
                                <label for="amount"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6">
                                            ...
                                            <label class="btn btn-outline-primary w-100 text-sm my-2 p-3"
                                            for="loan{{ $loan->id }}">&#8377;
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control @error('emi_amount') is-invalid @enderror"
                                        ...
                                        onchange="loadEMI()" placeholder="{{ __('Amount') }}">
                            ...
                            <div class="mb-3 row">
                                <label for="amount"
                                    class="col-md-2 col-form-label text-md-end text-start">{{ __('EMI Details') }}</label>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input type="number"
                                        class="form-control @error('stamp_duty') is-invalid @enderror" id="stamp_duty"
                                        name="stamp_duty" value="{{ old('stamp_duty', 0) }}"
