                    ...
                    <form action="{{ route('loan_matrix.update', $loan->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control @error('amount') is-invalid @enderror" id="amount" name="amount" value="{{ old('amount', $loan->amount) }}" placeholder="{{ __('Amount') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control @error('minimum_emi') is-invalid @enderror" id="minimum_emi" name="minimum_emi" value="{{ old('minimum_emi', $loan->minimum_emi) }}" placeholder="{{ __('Amount') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control @error('required_share') is-invalid @enderror" id="required_share" name="required_share" value="{{ old('required_share', $loan->required_share) }}" placeholder="{{ __('Required share') }}">
