                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="reg_date" value="{{ date('Y-m-d') }}" class="form-control date @error('reg_date') is-invalid @enderror">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="first-name-column">{{ __('Name') }}<span class="text-danger">*</span></label>
                            ...
                            {{-- {{ dump(Hash::make('12345678')); }} --}}

                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="email-id-column">{{ __('Email') }}<span class="text-danger">*</span></label>
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="{{ __('Email') }}">
                                    @if ($errors->has('email'))
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="password" class="form-control @error('password') is-invalid @enderror" placeholder="{{ __('Password') }}" name="password" value="{{ old('password') }}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="birthdate" value="{{ date('Y-m-d') }}" class="form-control date @error('birthdate') is-invalid @enderror" style="" placeholder="{{ __('Birth Date') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="total_share" onchange="calculate()" class="form-control @error('total_share') is-invalid @enderror" placeholder="{{ __('Total Share') }}" name="total_share" value="{{ old('total_share', $minimum_share) }}">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <input class="form-control ms-3" type="number" step="any" name="member_fee" value="{{ $setting->registration_fee }}" id="reg_fee" readonly>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8 form-group" id="payment_details" style="display: {{ old('payment_type') == 'cheque' ? 'block' : 'none' }};">
                                    <input type="number" class="form-control ms-3 @error('cheque_no') is-invalid @enderror" id="cheque_no" name="cheque_no" value="{{ old('cheque_no') }}" placeholder="{{ __('Cheque No.') }}">
