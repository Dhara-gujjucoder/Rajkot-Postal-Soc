        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Registration No') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Gender') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ __($user->gender) }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Email Address') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->user->email }}
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Mobile No') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->mobile_no }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Whatsapp No') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->whatsapp_no }}
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Current Address') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->current_address }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Parmenant Address') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Department') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Company') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->company }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Designation') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->designation }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Salary') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->salary }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('DA') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->da }}
                        </div>
                    </div>
                    ...
                    <br> <br>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Aadhar Card No') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->aadhar_card_no }}
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('PAN No') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->pan_no }}
                        </div>
                    </div>
                    ...
                    <br> <br>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Nominee Name') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->nominee_name }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Nominee Relation') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Bank Name') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->bank_name }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Branch Address') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->branch_address }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('Saving Account No') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->saving_account_no }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="email" class="col-md-5 col-form-label text-md-end text-start"><strong>{{ __('IFSC Code') }}:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $user->ifsc_code }}
                        </div>
                    </div>
