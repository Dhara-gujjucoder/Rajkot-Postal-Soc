<div class="mb-3 row">
    ...
    <input type="hidden" class="form-control" id="total_share_amt" name="total_share_amt"
        value="{{ old('total_share_amt', $member->shares->count() * current_share_amount()->share_amount) }}">
    ...
    <label for="amount"
        class="col-md-5 col-form-label text-md-end text-start"><b>{{ __('Member Information') }}</b></label>
</div>
<div class="mb-3 row">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-light-info"
                            id="old_principal_amt">&#8377;{{ $member->loan ? $member->loan->principal_amt : 0 }}
                        </span></td>
                </tr>
                <tr>
                    {{-- <td>&nbsp;</td> --}}
                    <td>{{ __('EMI') }} (&#8377;)</td>
                    <td><span class="badge bg-light-info"
                            id="old_emi_amt">&#8377;{{ $member->loan ? $member->loan->emi_amount : 0 }}
                        </span></td>
                </tr>
                <tr>
                    {{-- <td>&nbsp;</td> --}}
                    ...
                    <td><span class="badge bg-light-info"
                            id="remaining_emi_amt">&#8377;{{ $member->loan ? $member->loan_remaining_amount : 0 }}
                        </span></td>
                </tr>
                <tr class="bg-body-secondary">
                ...
                <tr>
                    ...
                    <td><span class="badge bg-light-info"
                            id="old_fixed_saving">&#8377;{{ $member->member_fixed['member_fixed_saving'] }}
                        </span></td>
                </tr>
                <tr>
                ...
                <input type="hidden" name="amount" placeholder="{{ __('Remaining Loan') }}" id="remaining_loan"
                    min="{{ $member->loan_remaining_amount }}" value="{{ $member->loan_remaining_amount }}">
                {{-- <tr>
                ...
                <tr>
                    ...
                    <td colspan="2"><input class="form-check-input payment_type ms-3" type="radio"
                            ...
                            {{ old('payment_type') == 'cash' ? 'checked' : '' }} onchange="change_payment_type()">
                        <label class="form-check-label pl-2" for="cash">
                            {{ __('Cash') }}
                        </label>
                        <input class="form-check-input payment_type ms-3" type="radio" name="payment_type"
                    ...
                    <td colspan="2">
                        <div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input type="number"
                                        class="form-control @error('cheque_no') is-invalid @enderror" id="cheque_no"
