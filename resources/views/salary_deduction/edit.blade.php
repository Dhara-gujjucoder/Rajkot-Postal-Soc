    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('salary_deduction.update',$salary_deduction->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row mb-3">

                            <label for="account_name"
                                class="col-md-4 col-form-label text-md-end">{{ __('Ledger') }}</label>
                            <div class="col-md-6">
                                <select class="choices form-select @error('ledger_ac_id') is-invalid @enderror"
                                    aria-label="Permissions" id="ledger_ac_id" name="ledger_ac_id" style="height: 210px;">
                                    <option value="">{{ __('Select Ledger') }}</option>
                                    @forelse ($ledgers as $key => $ledger)
                                    <option value="{{ $ledger->id }}"
                                        {{ $ledger->id == old('ledger_ac_id',$salary_deduction->ledger_ac_id) ? 'selected' : '' }}>
                                            {{ $ledger->account_name }}
                                        </option>
                                    @empty
                                    @endforelse
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="choices form-select @error('user_id') is-invalid @enderror"
                                    aria-label="Permissions" id="user_id" name="user_id" style="height: 210px;">
                                    <option value="">{{ __('Select Member') }}</option>
                                    @forelse ($members as $key => $member)
                                        <option value="{{ $member->user_id }}"
                                            {{ $member->user_id == old('user_id',$salary_deduction->user_id) ? 'selected' : '' }}>
                                            {{ $member->fullname }}
                                        </option>
                                    @empty
                                    @endforelse
                        ...
                        <div class="row mb-3">
                            ...
                            {{-- <label for="account_name"  class="col-md-4 col-form-label text-md-end">{{__('Department')}}</label> --}}
                            <div class="col-md-6">
                                <input type="number" id="rec_no"
                                    class="form-control @error('rec_no') is-invalid @enderror"
                                    placeholder="{{ __('Rec No.') }}" name="rec_no" value="{{ old('rec_no',$salary_deduction->rec_no) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="number" id="principal"
                                    ...
                                    placeholder="{{ __('Principal') }}" name="principal" value="{{ old('principal',$salary_deduction->principal) }}" onchange="calculate()">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="number" id="interest"
                                    ...
                                    placeholder="{{ __('Interest') }}" name="interest" value="{{ old('interest',$salary_deduction->interest) }}" onchange="calculate()">
                        ...
                        <div class="row mb-3">
                            <label for="fixed"
                                class="col-md-4 col-form-label text-md-end">{{ __('Fixed Monthly Saving') }} (Rs.)</label>
                            {{-- <label for="account_name"  class="col-md-4 col-form-label text-md-end">{{__('Department')}}</label> --}}
                            <div class="col-md-6">
                                <input type="number" id="fixed"
                                    class="form-control @error('fixed') is-invalid @enderror"
                                    placeholder="{{ __('Fixed Monthly Saving') }}" name="fixed"  value="{{ old('fixed',$salary_deduction->fixed) }}" onchange="calculate()">
                                @if ($errors->has('fixed'))
                        ...
                        <div class="row mb-3">
                            <label for="total_amount"
                                class="col-md-4 col-form-label text-md-end">{{ __('Total Amount') }} (Rs.)</label>
                            {{-- <label for="account_name"  class="col-md-4 col-form-label text-md-end">{{__('Department')}}</label> --}}
                            <div class="col-md-6">
                                <input type="number" id="total_amount"
                                    class="form-control @error('total_amount') is-invalid @enderror"
                                    placeholder="{{ __('Total Amount') }}" name="total_amount" value="{{$salary_deduction->total_amount}}"  disabled>
