                ...
                <div class="card-body">
                    <form action="{{ route('users.update', $user->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="notify_email" type="email" class="form-control @error('notification_email') is-invalid @enderror" name="notification_email" placeholder="{{ __('Notification Email') }}" value="{{$user->notification_email}}">
