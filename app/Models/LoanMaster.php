...
class LoanMaster extends Model
{
    ...
    protected $fillable = [
        ...
        'loan_id',
        'principal_amt',
        'emi_amount',    'loan_settlement_amt',    'total_share_amt',    'stamp_duty',    'fixed_saving',    'total_amt', 'payment_type',    'bank_name',    'cheque_no',    'g1_member_id',    'g2_member_id',    'cheque_no', 'bank_name',
